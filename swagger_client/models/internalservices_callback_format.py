...
class InternalservicesCallbackFormat(object):
    ...
    def __init__(self):  # noqa: E501
        """InternalservicesCallbackFormat - a model defined in Swagger"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InternalservicesCallbackFormat):
            return False
